...
<div class="">
    <p>
        <div class="fw-bold text-center">Laporan Kehadiran</div>
        <div class="fw-bold text-center"><?= $pertemuan['title'] ?? '-' ?></div>
        <div class="text-center"><?= date('d F Y', strtotime($pertemuan['start_at'])) ?></div>
    </p>
    <table class="table table-bordered border-dark w-100 mt-5 mb-5"  border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-start"><?= getKehadiran($member['presensi_status']) ?></td>
            </tr>
            <?php endforeach; else: ?>
            <tr>
